          ...
          <div className="max-w-3xl mx-auto text-center mb-20">
            ...
            <div className="w-full flex justify-center mt-6">
              <a href="https://mint.greenteadao.eth.limo/" target="_blank" rel="noopener noreferrer">
                <button className="btn text-gray-600 bg-gray-100 hover:bg-white shadow">Mint NFT & get Tea!</button>
              </a>
            </div>
              ...
              <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
                ...
                <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                  <div className="md:pr-4 lg:pr-12 xl:pr-16">
                    ...
                    <p className="text-xl text-gray-300 mb-4"> In the land of rising sun, green tea isn't just a beverage, it's a lifestyle.</p>
                  </div>
                </div>
              </div>
