    ...
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <hr style={{ borderTop: '1px solid #999', padding: '30px', paddingTop: '25px' }} />
          <div className="max-w-3xl mx-auto text-center mb-20">
            <Image src={boxImgae} alt="Japan Map" className="mx-auto" width={500} height={300} />
          </div>
          <h2 className="text-center text-2xl font-bold my-4">Meet the Tea from the Prefectures of Japan</h2>

          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <button onClick={handleToggle} style={{ textAlign: 'center', border: '1px solid', padding: '15px', borderRadius: '5px', marginBottom: '10px', opacity: 0.67 }}>
